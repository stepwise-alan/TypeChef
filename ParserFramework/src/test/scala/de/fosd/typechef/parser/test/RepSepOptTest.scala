...
class RepSepOptTest extends TestCase with DigitListUtilities {
  ...
  @Test def testPlainEmpty(): Unit = expectDigitList(List(), List())

  @Test def testPlainOne(): Unit = expectDigitList(List(t("1")), List(ol(1)))

  @Test def testPlainPair(): Unit = expectDigitList(List(t("1"), t(","), t("2")), List(ol(1), ol(2)))

  @Test def testOneFeatureOne(): Unit = expectDigitList(List(t("1", f1)), List(ol(1, f1)))

  @Test def testOneFeaturePair1(): Unit = expectDigitList(List(t("1"), t(",", f1), t("2", f1)), List(ol(1), ol(2, f1)))

  @Test def testOneFeaturePair2(): Unit = expectDigitList(List(t("1", f1), t(",", f1), t("2")), List(ol(1, f1), ol(2)))

  @Test def testOneFeatureTripple(): Unit = expectDigitList(List(t("1", f1), t(",", f1), t("2"), t(","), t("3")), List(ol(1, f1), ol(2), ol(3)))

  @Test def testAltComma1(): Unit = expectDigitList(List(t("1"), t(",", f1), t(",", f1.not()), t("2")), List(ol(1), ol(2)))

  @Test def testAltComma2(): Unit = expectDigitList(List(t("1"), t(",", f1), t(",", f1.not()), t("2", f1), t("3", f1.not())), List(ol(1), ol(2, f1), ol(3, f1.not())))

  @Test def testIncompleteList1(): Unit = expectDigitList(List(t("1"), t(","), t("2"), t(",")), List(ol(1), ol(2)))

  @Test def testIncompleteList2(): Unit = expectDigitList(List(t("1"), t(","), t("2", f1), t(","), t("3")), List(ol(1), ol(2, f1)), 2)


  @Test def testEasylist(): Unit = easyList(100)

  @Test def testHardlist(): Unit = hardList(100)

  @Test def testHardlist2(): Unit = hardList2(100)

  @Test def testAnnotatedList(): Unit = annotatedList(100)


  @Test def testAlternativeEntries(): Unit = expectDigitList(List(t("1", f1), t("2", f1.not()), t(","), t("3")), List(ol(1, f1), ol(2, f1.not()), ol(3)))

  @Test def testAlternativeEntries2(): Unit = expectDigitList(List(t("1", f1), t("2", f2), t(",", f1 or f2), t("3")), List(ol(1, f1), ol(2, f2), ol(3)))

  @Test def testAlternativeEntries3(): Unit = expectDigitList(List(t("1", f1), t("2", f2), t(","), t("3")), List(ol(1, f1), ol(2, f2)), 2)

  //abort at comma
  @Test def testAlternativeEntries4(): Unit = expectDigitList(List(t("1", f1), t("2", f2), t(",", f1 or f2), t("3")), List(ol(1, f1), ol(2, f2), ol(3)))
  ...
  private def easyList(length: Int): Unit = {
    var l = List(t("0"))
  ...
  private def hardList(length: Int): Unit = {
    var l = List(t("0"), t(","))
    var expected = List(ol(0))
    for (i <- 1 until length) {
      val f = FeatureExprFactory.createDefinedExternal("f" + i)
   ...
   */
  private def hardList2(length: Int): Unit = {
   ...
   */
  private def annotatedList(length: Int): Unit = {
  ...
  private def expectDigitList(providedList: List[MyToken], expectedEntries: List[Opt[Lit]], expectUnparsedTokens: Int = 0): Unit = {
